...
.controller('DishDetailController', ['$scope', 'dish', '$stateParams', 'menuFactory', 'favoriteFactory', 'baseURL', '$ionicPopover', '$ionicListDelegate', '$ionicModal', function ($scope, dish, $stateParams, menuFactory, favoriteFactory, baseURL, $ionicPopover, $ionicListDelegate, $ionicModal) {
  ...
  $scope.submitComment = function () {
    ...
    $scope.mycomment.rating = $scope.commentForm.rating;
    $scope.mycomment.comment = $scope.commentForm.comment;
    $scope.mycomment.author = $scope.commentForm.author;
...
.controller('IndexController', ['$scope', 'dish', 'leader', 'promotion', '$stateParams', 'baseURL', function ($scope, dish, leader, promotion, $stateParams, baseURL) {
  $scope.baseURL = baseURL;
  $scope.leader = leader;
  $scope.showDish = false;
...
.controller('FavoritesController', ['$scope', 'dishes', 'favorites', 'menuFactory', 'favoriteFactory', 'baseURL', '$ionicListDelegate', '$ionicPopup', '$ionicLoading', '$timeout', function ($scope, dishes, favorites, menuFactory, favoriteFactory, baseURL, $ionicListDelegate, $ionicPopup, $ionicLoading, $timeout) {
  ...
  console.log(" data scope favorites " + $scope.favorites);

  $scope.dishes = dishes;

  console.log(" data scope " + $scope.dishes, $scope.favorites);
